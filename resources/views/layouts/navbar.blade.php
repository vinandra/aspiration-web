    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1 ">
            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                ...
                <!-- Counter - Alerts -->
                <span class="badge badge-primary badge-counter">{{ count(auth()->user()->unreadNotifications)}}</span>
            </a>
            <!-- Dropdown - Alerts -->
                ...
                @foreach (auth()->user()->notifications  as $notification)
                    @if ( is_null($notification->read_at))
                        <form id='formNotification{{ $notification->id }}' action="/notification/{{ $notification->id }}/read" method="post">
                            <div class="dropdown-item d-flex align-items-center" style="background-color: rgba(115, 194, 251, 0.15); cursor: pointer;"
